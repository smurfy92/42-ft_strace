...
case EAGAIN:
	...
	case EWOULDBLOCK:
	return ft_strjoin_nf(ft_strjoin("EWOULDBLOCK (" , strerror(EWOULDBLOCK)), ")", 1);
case EINPROGRESS:
...
case EPROCLIM:
	return ft_strjoin_nf(ft_strjoin("EPROCLIM (" , strerror(EPROCLIM)), ")", 1);
case EUSERS:
...
case EBADRPC:
	return ft_strjoin_nf(ft_strjoin("EBADRPC (" , strerror(EBADRPC)), ")", 1);
case ERPCMISMATCH:
	return ft_strjoin_nf(ft_strjoin("ERPCMISMATCH (" , strerror(ERPCMISMATCH)), ")", 1);
case EPROGUNAVAIL:
	return ft_strjoin_nf(ft_strjoin("EPROGUNAVAIL (" , strerror(EPROGUNAVAIL)), ")", 1);
case EPROGMISMATCH:
	return ft_strjoin_nf(ft_strjoin("EPROGMISMATCH (" , strerror(EPROGMISMATCH)), ")", 1);
case EPROCUNAVAIL:
	return ft_strjoin_nf(ft_strjoin("EPROCUNAVAIL (" , strerror(EPROCUNAVAIL)), ")", 1);
case ENOLCK:
	return ft_strjoin_nf(ft_strjoin("ENOLCK (" , strerror(ENOLCK)), ")", 1);
case EFTYPE:
	return ft_strjoin_nf(ft_strjoin("EFTYPE (" , strerror(EFTYPE)), ")", 1);
case EAUTH:
	return ft_strjoin_nf(ft_strjoin("EAUTH (" , strerror(EAUTH)), ")", 1);
case ENEEDAUTH:
	return ft_strjoin_nf(ft_strjoin("ENEEDAUTH (" , strerror(ENEEDAUTH)), ")", 1);
case ENOSYS:
	return ft_strjoin_nf(ft_strjoin("ENOSYS (" , strerror(ENOSYS)), ")", 1);
case ENOTSUP:
	return ft_strjoin_nf(ft_strjoin("ENOTSUP (" , strerror(ENOTSUP)), ")", 1);
case EILSEQ:
	return ft_strjoin_nf(ft_strjoin("EILSEQ (" , strerror(EILSEQ)), ")", 1);
case EBACKGROUND:
	return ft_strjoin_nf(ft_strjoin("EBACKGROUND (" , strerror(EBACKGROUND)), ")", 1);
case EDIED:
	return ft_strjoin_nf(ft_strjoin("EDIED (" , strerror(EDIED)), ")", 1);
case ED:
	return ft_strjoin_nf(ft_strjoin("ED (" , strerror(ED)), ")", 1);
case EGREGIOUS:
	return ft_strjoin_nf(ft_strjoin("EGREGIOUS (" , strerror(EGREGIOUS)), ")", 1);
case EIEIO:
	return ft_strjoin_nf(ft_strjoin("EIEIO (" , strerror(EIEIO)), ")", 1);
case EGRATUITOUS:
	return ft_strjoin_nf(ft_strjoin("EGRATUITOUS (" , strerror(EGRATUITOUS)), ")", 1);
case EBADMSG:
...
case EDEADLOCK:
	return ft_strjoin_nf(ft_strjoin("EDEADLOCK (" , strerror(EDEADLOCK)), ")", 1);
case EBFONT:
